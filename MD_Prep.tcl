...
proc run {outname} {
	...
	set fix [atomselect top "protein or water or name CLA SOD POT or (resname POPC and name N P HA HB HS HX HY C1 C2 C3 C11 H11A H11B O11 C12 H12A H12B O12 C13 H13A H13B H13C O13 C14 H14A H14B H14C O14 C15 H15A H15B H15C C21 O21 C31 O31 O22 O32) or resname CAMP" ]
...
## 	Creates the config files
	...
	foreach ending $suffix cfg $configs {
		...
		puts $ofile [format "structure\t\t$outname\.psf"]
		puts $ofile [format "coordinates\t\t$outname\.pdb"]
